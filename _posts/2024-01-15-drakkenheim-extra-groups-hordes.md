...
**Misty Camouflage (group).** A dreg group has advantage on Dexterity (Stealth) checks to hide in any area obscored by mist or fog.
...
**Misty Camouflage (horde).** A dreg horde has advantage on Dexterity (Stealth) checks to hide in any area obscored by mist or fog.
...
**BONUS ACTIONS**
<br>
**Dreg Tricks.** As a bonus action, the horde unleashes two special dreg attack. Pick two randomly or choose between these (see the stat blocks for the various type of dregs for the effect):
1. Bile Spray
2. Psychic Scream
3. Octarine Beam
4. Blood Drain (doesn't move with the target, automatically detaches if the target moves away)
...
**ACTIONS**
<br>
**Spears.** Melee Weapon Attack +5 to hit, reach 10 ft. or range 20/60, one target. Hit 10 (2d6+3) piercing damage. 

**BONUS ACTIONS**
<br>
**Rampage (group).** When the group reduces a creature to 0 hit points with a melee attack on its turn, as a bonus action it can move up to half its sepeed and make a Spears attack.
...
**ACTIONS**
<br>
**Spears.** Melee Weapon Attack +5 to hit, reach 10 ft. or range 20/60, one target. Hit 18 (4d6+4) piercing damage. 
